...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('penjualans', function (Blueprint $table) {
            $table->id('id_jual'); // id_beli INT64 NOT NULL AUTO_INCREMENT PRIMARY KEY
            $table->string('nama_pembeli')->nullable(); // nama_supplier STRING
            ...
            $table->date('tgl_jual')->nullable(); // tgl_beli DATE
